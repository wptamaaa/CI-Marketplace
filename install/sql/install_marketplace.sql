...
(542, 1, 'mode', 'Mode'),
(543, 1, 'location_exp', 'Marketplace allows you to shop from anywhere in the world.'),
(544, 1, 'monday', 'Monday'),
(545, 1, 'month', 'Month'),
...
(1, 1, 19, 22, 'Marketplace - Classified Ads Script', 'Home', 'Marketplace Index Page', 'index, home, marketplace', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Copyright 2021 Marketplace - All Rights Reserved.', 0, NULL, '2021-02-20 22:51:50');
...
ALTER TABLE `app_sessions`
  ADD KEY `app_sessions_timestamp` (`timestamp`);
