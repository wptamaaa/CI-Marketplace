...
<head>
    ...
    <title>Marketplace - Installer</title>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group" style="display: none;">
                                                ...
                                                <textarea name="license_code" class="form-control form-input" style="resize: vertical; height: 100px;line-height: 24px;padding: 10px;" placeholder="Enter License Code" required>c7508ef3-cd07-47ed-9991-bab2a9f8b72d</textarea>
                                            </div>
                                        </div>
                                    </div>
