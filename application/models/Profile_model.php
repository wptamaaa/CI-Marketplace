...
class Profile_model extends CI_Model
{
    ...
    public function update_profile($data, $user_id)
    {
        ...
        $this->session->set_userdata('emarket_user_old_email', $this->auth_user->email);
    ...
    public function check_email_updated($user_id)
    {
        ...
        if ($this->general_settings->email_verification == 1) {
            ...
            if (!empty($user)) {
                if (!empty($this->session->userdata('emarket_user_old_email')) && $this->session->userdata('emarket_user_old_email') != $user->email) {
                    //send confirm email
            ...
            if (!empty($this->session->userdata('emarket_user_old_email'))) {
                $this->session->unset_userdata('emarket_user_old_email');
            }
        }
