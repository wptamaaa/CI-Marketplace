...
class Cart_controller extends Home_Core_Controller
{
    ...
    public function payment_method()
    {
        ...
        if ($payment_type == "sale") {
            ...
            $plan_id = $this->session->userdata('emarket_selected_membership_plan_id');
            if (empty($plan_id)) {
                redirect(lang_base_url());
                exit();
            }
            ...
            $data['promoted_plan'] = $this->session->userdata('emarket_selected_promoted_plan');
    ...
    public function execute_payment($data_transaction, $payment_type, $base_url)
    {
        ...
        if ($payment_type == 'sale') {
            ...
            $promoted_plan = $this->session->userdata('emarket_selected_promoted_plan');
