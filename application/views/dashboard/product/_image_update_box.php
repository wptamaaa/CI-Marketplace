        ...
        <ul class="dm-uploaded-files" id="files-image">
            <?php if (!empty($emarket_images)):
                foreach ($emarket_images as $emarket_image): ?>
                    <li class="media">
                        <img src="<?php echo get_product_image_url($emarket_image, 'image_small'); ?>" alt="">
                        <a href="javascript:void(0)" class="btn-img-delete btn-delete-product-img" data-file-id="<?php echo $emarket_image->id; ?>">
                        ...
                        <?php else: ?>
                            <a href="javascript:void(0)" class="btn btn-xs btn-secondary btn-is-image-main btn-set-image-main" data-image-id="<?php echo $emarket_image->id; ?>" data-product-id="<?php echo $emarket_image->product_id; ?>"><?php echo trans("main"); ?></a>
                        <?php endif; ?>
                    </li>
                <?php endforeach;
            endif; ?>
