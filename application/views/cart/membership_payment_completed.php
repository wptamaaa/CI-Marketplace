        ...
        <div class="row">
            <div class="col-12">
                <div class="page-confirm">
                    ...
                    <?php if(!empty($this->session->userdata('emarket_membership_request_type')) && $this->session->userdata('emarket_membership_request_type') =="renew"): ?>
...
<?php
if(!empty($this->session->userdata('emarket_selected_membership_plan_id'))){
    $this->session->unset_userdata('emarket_selected_membership_plan_id');
}
